		...
		/*icons: [{
		 ...
		 onChange: function(newValue,oldValue){
			    ...
			    if(newValue==null||newValue==""){
			    	  $("#cc_propertyparent").combogrid("grid").datagrid("loadData",[]);
			    	  //$('#dg').datagrid('clearChecked');
					 //$('#dg').datagrid("loadData",[]);
			    }else{
			    	  var url_context_combogrid=extras_Hosting["tomcatSpring_context"]+'ad/propertyController/get_property_parent_byproducttypeid.json?product_type_id='+newValue;
					   $("#cc_propertyparent").combogrid({url:url_context_combogrid});
					   $('#dg').datagrid('clearChecked');
					   $('#dg').datagrid("loadData",[]);
			    }
