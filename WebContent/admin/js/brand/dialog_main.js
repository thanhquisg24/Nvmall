		...
		/*icons: [{
		 ...
		 onChange: function(newValue,oldValue){
			    ...
			    if(newValue==null||newValue==""){
			    	  ...
			    	  var url_context_grid_branch_of=extras_Hosting["tomcatSpring_context"]+'ad/branchController/get_datagrip_byproducttypeid.json?product_type_id='+newValue;
					  $('#dg').datagrid('clearChecked');
					  $('#dg').datagrid({url:url_context_grid_branch_of});
			    }
