$(function(){
	extras_GET_json(true,"ad/RuleController","get_scheme",{},function(data){
		if(data !== null && typeof data === "object"){
			$("#my_editor_scheme").val(data.content_page)
			tinymce.remove();
			tinymce.init({
				selector:'#my_editor_scheme',
			    height : 350,
	...
	$("#id_save_rule").click(function(){
		var MCEeditor=tinymce.get('my_editor_scheme');
