(function(k, f, c, j, d, l, g) {/* ! Jssor */
	...
	var b = new function() {
		var h = this, Ab = /\S+/g, L = 1, jb = 2, nb = 3, mb = 4, rb = 5, M, s = 0, i = 0, t = 0, z = 0, A = 0, D = navigator, vb = D.appName, o = D.userAgent, q = parseFloat;
		function Jb() {
			if (!M) {
				M = {
				...
				if (D.pointerEnabled || (a = D.msPointerEnabled))
					M.ld = a ? "msTouchAction" : "touchAction"
			}
			return M
		}
		function v(h) {
		...
		h.$Delay = yb;
		function bb(a) {
			a.constructor === bb.caller && a.Jd
					&& a.Jd.apply(a, bb.caller.arguments)
		}
		h.Jd = bb;
		h.nb = function(a) {
			if (h.cf(a))
		...
		function w(f, l) {
			...
			function k(b, d, a) {
				var e = b.gb(p(-d / 2, -a / 2)), f = b.gb(p(d / 2, -a / 2)), g = b
						.gb(p(d / 2, a / 2)), h = b.gb(p(-d / 2, a / 2));
				b.gb(p(300, 300));
		...
		h.Yc = function(l, m, w, n, y, z, o) {
			...
			if (l) {
				...
				for ( var h in m) {
					...
					if (f != u)
						f -= u;
					var i = n.lc || e.$EaseSwing, k, B = l[h], q = m[h];
					if (b.Ub(q)) {
						i = n[h] || i;
						var x = i(f);
						k = B + q * x
			...
			if (m.$Clip && o.$Move) {
				var p = a.$Clip.Ib, s = (p.$Top || 0) + (p.$Bottom || 0), r = (p.$Left || 0)
						+ (p.$Right || 0);
				a.$Left = (a.$Left || 0) + r;
				a.$Top = (a.$Top || 0) + s;
				a.$Clip.$Left -= r;
			...
			if (a.$Clip && b.Zf() && !a.$Clip.$Top && !a.$Clip.$Left
	...
	k.$JssorSlideshowRunner$ = function(k, s, q, t, y) {
		...
		function o(B, h, a, w, o, m) {
			var z = this, u, v = {}, i = {}, n = [], f, e, s, q = a.$ChessMode.$Column || 0, r = a.$ChessMode.$Row || 0, g = a
					.oe(o, m), p = C(a), D = p.length - 1, t = a.$Duration
	...
	var i = k.$JssorSlider$ = function(p, hc) {
		...
		function Bc(k, f) {
			var e = this, q, H, x, o, y = [], w, B, W, G, Q, F, g, v, p;
			m.call(e, -u, u + 1, {});
			function E(a) {
				q && q.Bd();
				T(k, a, 0);
		...
		var qb = a.$BulletNavigatorOptions, W = a.$ArrowNavigatorOptions, ab = a.$ThumbnailNavigatorOptions, Q = !a.$UISearchMode, y, v = b
				.B(p, "slides", Q), cb = b.B(p, "loading", Q) || b.eb(f), Jb = b
				.B(p, "navigator", Q), ec = b.B(p, "arrowleft", Q), cc = b.B(p,
				"arrowright", Q), Hb = b.B(p, "thumbnavigator", Q), pc = b.k(v), oc = b
				.m(v), V, T = [], yc = b.zb(v);
		b.a(yc, function(a) {
		...
		f.yc = function(E) {
			if (!u) {
				...
				for (var f = 0; f < s; f++) {
					...
					a.$ActionMode & 2
							&& b.e(l, "mouseover", b.Jb(b.G(j, t, f), l));
					y[f] = b.Lb(l)
				}
				u = d
			}
	...
	k.$JssorThumbnailNavigator$ = function(g, B) {
		...
		function A(n, f) {
			...
			function i(d) {
				if (d || !s.$LastDragSucceded()) {
					var a = e - f % e, b = s.kd((f + a) / e - 1), c = b * e + e
							- a;
					h.l(o.Vb, c)
				}
			}
		...
		h.yc = function(F, D) {
			if (!w) {
				...
				var j = [];
				b.a(D, function(l, g) {
					var i = new A(l, g), d = i.Pb, a = c.floor(g / e), k = g
							% e;
					b.v(d, (u + q) * k * (1 - h));
					b.z(d, (t + r) * k * h);
					if (!j[a]) {
	...
	k.$JssorCaptionSlideo$ = function(n, f, l) {
		...
		function k(e, c) {
			...
			b.a(d, function(d) {
				...
				if (h) {
					var e = b.j(d, "t"), g = i[b.vc(e)] || i[e], f = {
						$Elmt : d,
						wc : g
					};
					a.push(f)
